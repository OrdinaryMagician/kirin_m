...
And so goes our emperor, with nothing in hand but his wits and his magic. May his adventures serve to make his beloved spouses proud, and for this ravaged world to see peace once more.
...
There are four weapons available throughout your journey. As this is a mod for **Hexen**, that's very much the "ideal" layout. The only bindings you ever need are both fire buttons, reload and zoom.
...
One of the most common **Anarukon** handguns. Firing small 6mm steel bolts, it does not have a lot of killing potential, but then again, it is a weapon designed for civilian self-defense. Putting a couple of these in an enemy will make it topple down in no time, however. Each magazine holds 12 rounds. **Kirin** can carry up to 60 rounds in total.
...
Like any **Anarukon** firearm, the weapon not only needs to be reloaded with more bullets, but also have its inner mana supply replenished in order for it to actually fire off rounds. This recharge process is done through the zoom key.

### Slot 3 - Sokana Fragment Carbine
...
### Slot 4 - Unissix Crafts Warp Ballista
...
The spell that **Kirin** had learned to impress **Saya** and the girls back when they were first dating. It's proven to be very effective at healing, apart from having a relaxing warmth to it.
...
Invoke a blade of verdant wild pyromancy, allowing you to slash at foes with searing acidic fire. This is a spell that **Kirin** personally learned from his good friend **Dread Overlord Nuoma**, conqueror of the ashlands of **Kruon**.

Before anything is to be done, either fire button will first summon the blade, after that, primary fire will perform side swipes, while secondary fire does a thrusting attack. Each of these attacks will release shockwaves, so they're still effective at a short to medium range.

Note that for as long as the blade is active, your mana will slowly drain, so don't keep it out at all times.
...
### Candy Bean *[Crystal Vial, Mystic Ambit Incant]*
...
Found in bunches of 4 rounds. **Kirin** will skillfully load them into his reserve mags as he picks them up, and leave any excess behind.

### 10mm Frag *[Green Mana]*

Found in pairs of 2 rounds. **Kirin** only grabs what he needs, of course.

### Assorted Ammo *[Combined Mana]*

5 pistol rounds and 3 shells.

### Ammo Pack *[Krater of Might]*

30 pistol rounds and 15 shells in one package, plus a ballista round!
...
Invented by **Saya** to quickly get rid of annoying pests. Shoves away everything around you on use, with great violence.

### Safety Tether *[Chaos Device]*

Yet another gift from **Saya**. She wants to ensure that you don't need to perform a scattering should you ever get caught in an inescapable trap. This device will immediately transport you back to the entrypoint of the current area on use. The design looks oddly familiar, although you can't quite tell why.
